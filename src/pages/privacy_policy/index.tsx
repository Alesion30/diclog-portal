      ...
      <Container>
        ...
        <ul>
          <li>
            ...
            <br />
            Diclogプライバシーポリシー（以下「本ポリシー」といいます。）において、利用者情報とは、ユーザーに関する個人情報（個人情報保護法第２条第１項により定義された「個人情報」をいい、以下同様とします。）、ユーザーの入力情報、通信サービス上の行動履歴その他ユーザーの情報端末において生成又は蓄積された情報、及び提携パートナーによる提携サービスの提供に伴い取得したユーザーに関する情報であって、本ポリシーに基づき当研究室が収集するものを意味します。
          </li>
          <br />
          <li>
            ...
            <ol className="list-decimal pl-5">
              <li>
                ...
                (4) メールアドレス
                <br />
                (5) その他当研究室が定める登録フォームにてユーザーが入力する情報
                <br />
              </li>
              <br />
              <li>
