      ...
      <Container>
        ...
        <ul>
          <li>
            ...
            <br />
            ウォーカスプライバシーポリシー（以下「本ポリシー」といいます。）において、利用者情報とは、ユーザーに関する個人情報（個人情報保護法第２条第１項により定義された「個人情報」をいい、以下同様とします。）、ユーザーの入力情報、通信サービス上の行動履歴その他ユーザーの情報端末において生成又は蓄積された情報、及び提携パートナーによる提携サービスの提供に伴い取得したユーザーに関する情報であって、本ポリシーに基づき当研究室が収集するものを意味します。
          </li>
          <br />
          <li>
            ...
            <ol>
              <li>
                当研究室が提供するウォーカス、関連ソフトウェア（以下「本アプリ」といいます。）をインストールすることによりユーザーが利用することができるサービス、及び本アプリと連動させて利用可能なWebサービス「ダッシュボード」（以下総称して「本サービス」といいます。）において、当研究室は、ユーザーから、次の情報の全部又は一部を提供していただきます。
                <br />
                (1) 氏名 (2) 住所 (3) 生年月日 (4) メールアドレス (5) 性別 (6)
                身長 (7) 体重 (8) プロフィール写真その他の写真、画像データ (9)
              ...
              <li>
                ...
                (2) アクセスログ情報 (3)
                IDFA、AdvertisingID及びCookie（クッキー） (4) 位置情報 (5)
                通信機器に付属するセンサー情報 (6) 端末内の写真、画像データ
                ※ユーザーが写真へのアクセスを許可した場合に限ります。 (7)
                各種健康機器から送信されるバイタルデータ等の情報 (8)
                各サービスの利用に伴い投稿その他の方法によりユーザーが発信する情報
                (9) 各サービスのご利用履歴 (10) facebook ID
                ＊ユーザーの意志により連携した場合のみ (11)
                クーポン、ポイント等のサービスに関する情報 (12)
                アンケート調査・モニター調査等に関する情報 (13)
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                (3) ユーザーに合わせた本サービス上の情報配信のカスタマイズのため
                (4) 本サービスに関するご案内のため (5)
                本サービスの停止・中止・契約解除の通知のため (6)
                本サービスの利用規約に違反する行為への対応のため (7)
                本サービスに関する当研究室の規約、本ポリシー等の変更などの通知のため
                (8) 紛争、訴訟などへの対応のため (9)
                本サービスに関するご案内、お問い合わせ等への対応のため (10)
                市場調査、分析、マーケティング及び調査研究のため (11)
                個人を識別できない形式に加工した統計データを作成するため (12)
              ...
              <li>
                ...
                <ul>
                  <li>
                    当研究室から第三者へ提供される利用者情報の項目
                    <br />
                    住所、生年月日、性別、身長、体重、位置情報、その他上記利用目的を達成するために必要な範囲内の情報
                  </li>
                  <li>
                    第三者への提供の手段又は方法
                    <br />
                  ...
                  <li>
                    第三者への提供の停止のご請求
                    <br />
                    当研究室は、ユーザーから第三者への提供の停止等のお申出があった場合、第三者への提供の停止等適切な措置を講じます。詳しくは、第13条第３項及び第14条をご確認ください。
                  </li>
                </ul>
              </li>
            </ol>
          ...
          <br />
          <li>
            <strong>第11条（利用者情報の開示・共有）</strong>
            <br />
          ...
          <br />
          <li>
            <strong>第13条（利用者情報の開示・訂正等）</strong>
            <ol>
              <li>
          ...
          <li>
            ...
            <div>
              ...
              <br />
              E-mail:
              <a href="mailto:ubiapp.naist@gmail.com">ubiapp.naist@gmail.com</a>
              <br />
